...
const initializeLocalStorage = ()=>{
    if (localStorage.getItem("feedback-form-state") === null) localStorage.setItem("feedback-form-state", JSON.stringify({
        email: "",
        message: ""
    }));
};
...
const formUpdateOnstart = (localStorageData1)=>{
    if (localStorageData1.email != "") inputEmail.value = localStorageData1.email;
    if (localStorageData1.message != "") inputMessage.value = localStorageData1.message;
};
...
const localStorageUpdate = (0, _lodashThrottleDefault.default)(()=>{
